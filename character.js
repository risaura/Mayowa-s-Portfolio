class SceneManager {
    ...
    drawAboutMeSection() {
        ...
        if (sectionX > -this.sections.aboutMe.width && sectionX < this.canvas.width) {
            // About Me board
            const boardX = sectionX + 250;
            const boardY = 150;
            
            // Board background
            this.ctx.fillStyle = 'rgba(255, 255, 255, 0.95)';
            this.ctx.fillRect(boardX, boardY, 400, 300);
            this.ctx.strokeStyle = '#8B4513';
            this.ctx.lineWidth = 5;
            this.ctx.strokeRect(boardX, boardY, 400, 300);
            
            // Title
            this.ctx.fillStyle = '#667eea';
            this.ctx.font = 'bold 32px Poppins';
            this.ctx.textAlign = 'center';
            this.ctx.fillText('About Me', boardX + 200, boardY + 50);
            ...
            const lines = [
                ...
                '🎨 Animation',
                '',
                'Move right to see my games! →'
            ];
            
            lines.forEach((line, i) => {
                this.ctx.fillText(line, boardX + 30, boardY + 100 + i * 24);
            });
        }
    }
